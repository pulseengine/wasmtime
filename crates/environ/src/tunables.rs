...
define_tunables! {
    ...
    pub struct Tunables {
        ...
        /// where the lift and lower instances are the same. Needed for fused
        /// components where multiple component instances are merged into one.
...
impl Tunables {
    ...
    pub const fn default_miri() -> Tunables {
        Tunables {
            ...
            debug_guest: false,
            allow_recursive_reentrance: false,
        }
    }
